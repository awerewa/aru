...
func _process(delta):
	if Input.is_anything_pressed() == true:
		if Input.is_action_just_pressed("attack"):
			...
			# print("moved up")
			Input.is_action_just_released("up") or Input.is_action_just_pressed("left") or Input.is_action_just_pressed("right") or Input.is_action_just_pressed("down") or Input.is_action_just_pressed("attack")
		elif Input.is_action_just_pressed("down"):
			currentaction = "dodgedown"
			global_position = Vector2(284,116)
			# print("moved down")
			Input.is_action_just_released("down") or Input.is_action_just_pressed("left") or Input.is_action_just_pressed("up") or Input.is_action_just_pressed("right") or Input.is_action_just_pressed("attack")
		elif Input.is_action_just_pressed("right"):
			currentaction = "dodgeback"
			global_position = Vector2(304,88)
			# print("moved back")
			Input.is_action_just_released("right") or Input.is_action_just_pressed("left") or Input.is_action_just_pressed("up") or Input.is_action_just_pressed("down") or Input.is_action_just_pressed("attack")
		elif Input.is_action_just_pressed("left"):
			currentaction = "block"
			global_position = Vector2(208,88)
			# print("now blocking")
			Input.is_action_just_released("left") or Input.is_action_just_pressed("right") or Input.is_action_just_pressed("up") or Input.is_action_just_pressed("down") or Input.is_action_just_pressed("attack")
